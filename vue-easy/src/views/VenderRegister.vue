      ...
      <div class="card-body">
        ...
        <div class="row g-3 needs-validation">
          <div class="col-md-6 position-relative">
            ...
            <input required type="text" class="form-control" id="acct" name="acct" placeholder="6-15位中英字" v-model="acct"
              oninput="chkAcct()">
          ...
          <div class="col-md-4 position-relative">
            ...
            <input required type="text" class="form-control" id="coname" name="coname" v-model="coname"
              oninput="chkConame()">
          ...
          <div class="col-md-4 position-relative">
            ...
            <input required type="text" class="form-control" id="username" name="username" v-model="username"
              oninput="chkUsername()">
          ...
          <div class="col-md-4 position-relative">
            ...
            <input required type="text" class="form-control" name="uninum" id="uninum" v-model="uninum"
              oninput="chkUninum()">
          ...
          <div class="col-md-4 position-relative">
            ...
            <input required type="text" class="form-control" id="email" name="email" v-model="email"
              placeholder="xxxx@gmail.com" oninput="chkEmail()">
          ...
          <div class="col-md-4 position-relative">
            ...
            <input required type="text" class="form-control" id="mobile" name="mobile" v-model="mobile"
              placeholder="09xx-xxxxxx" oninput="chkMobile()">
          ...
          <div class="col-md-6 position-relative">
            ...
            <input required type="password" class="form-control" id="pwd" name="pwd" v-model="pwd" placeholder="6-15位中英字"
              oninput="chkPwd()">
          ...
          <div class="col-md-6 position-relative mb-3">
            ...
            <input required type="password" class="form-control" id="repwd" name="repwd" v-model="repwd"
              placeholder="6-15位中英字" oninput="chkPwdChk()">
          ...
          <div class="col-md-4 position-relative">
            ...
            <select class="form-select" name="address1" id="address1" v-model="address1" onblur="Address1chk()"
              @change="watchEffect()">
              <option value="">請選擇</option>
              <option v-for="city in data" :value="city.name" :key="city.name">{{ city.name }}</option>
            </select>
            <div class="invalid-feedback">
              必填
            </div>
          ...
          <div class="col-md-4 position-relative">
            ...
            <select class="form-select" name="address2" id="address2" v-model="address2" onblur="chkAddress2()">
              <option value="">請選擇</option>
              <option v-for="town in towns" :value="town.zip" :key="town.zip">{{ town.zip + town.name }}</option>
            </select>
            <div class="invalid-feedback">
              必填
            </div>
...
const submitData = () => {
  ...
  street.value = '中華路116號'
  email.value = 'c2311505good@yahoo.com.tw'
  coname.value = '衝浪勒有限公司'
  uninum.value = '00003219'
}
